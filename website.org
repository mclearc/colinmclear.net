...
# Note that since we use PaperMod profileMode we need to update the subtitle in the toml file to change the home page!

This site collects my [[/research][research]], [[/teaching][teaching]], and occasional [[/posts][blog posts]] on the history of modern philosophy and the philosophy of mind. My philosophical work focuses primarily on Kant and related figures in early modern philosophy and German Idealism, especially questions about perception, cognition, and self-knowledge.

Formerly, I was Associate Professor of Philosophy at the University of Nebraska-Lincoln from 2013 to 2025, and I continue to work on these topics independently. My complete CV is available as [[file:/materials/McLearCV.pdf][PDF]] or [[file:/materials/McLearCV.html][HTML]].
...
At UNL I regularly taught courses on the history of modern philosophy, Kant, and German Idealism at both undergraduate and graduate levels, as well as introductory courses in philosophy. These included [[http://phil105.colinmclear.net][The Philosophy of Food (PHIL 105)]], [[file:/materials/course-syllabi/phil101-syllabus.pdf][Introduction to Philosophy (PHIL 101)]], [[file:/materials/course-syllabi/phil232-syllabus.pdf][History of Early Modern Philosophy (PHIL 232)]], and seminars on [[https://phil871.colinmclear.net][Kant (PHIL 471/871)]], [[https://phil880.colinmclear.net][German Idealism (PHIL 480/880)]], [[file:/materials/course-syllabi/kant-modern-syllabus.pdf][Early Modern Philosophy (PHIL 460/860)]], and related topics (PHIL 971). Course materials and syllabi from selected courses are available below.
...
- PHIL 971 (Fall 2020): [[https://phil971-2020.colinmclear.net][Kantian Conceptions of Rational Agency]]
...
- [[https://users.manchester.edu/facstaff/ssnaragon/kant/Home/index.htm][Kant in the Classroom]] (Steve Naragon)
...
Dr. Colin McLear\\
Email: [[mailto:mclear@fastmail.com][mclear@fastmail.com]] \\


Email is the best way to reach me. I answer emails as soon as I can, but
typically only on /weekdays/.
...
[[/ox-hugo/Screen Shot 2021-10-16 at 12.34.44 AM.png]]

Into a nice looking set of PDF notes like this:

[[/ox-hugo/Screen Shot 2021-10-16 at 12.37.50 AM.png]]

Or a set of slides like this:

[[/ox-hugo/Screen Shot 2021-10-16 at 12.40.53 AM.png]]
...
but it /is/ easy to comment as necessary on one's code, and you can use packages
...
can see the setup of outline mode [[https://github.com/Lambda-Emacs/lambda-emacs/blob/286860f01842a3be14d03fa99cc06942f6d03045/init.el#L278][here]] and the search functions [[https://github.com/Lambda-Emacs/lambda-emacs/blob/286860f01842a3be14d03fa99cc06942f6d03045/lambda-library/lambda-setup/lem-setup-functions.el#L48][here]].
