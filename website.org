...
#+HTML:<style> .xpapers_abstract { font-size:smaller; padding:6px } .xpapers_pubtype {font-size:28px} .publication-title {font-weight:regular } .publication-cite { color : #444 } </style>

#+HTML: <div id='ppl-widget-container'>One moment, publications loading ... (or view them <a href="https://philpapers.org/profile/740?widget_failed=1">here</a>)</div> <script type="text/javascript" src="https://philpeople.org/widget/740.js"></script>
